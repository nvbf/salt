...
class IndexPage extends React.Component {
    ...
    render () {
        ...
        return (
            <Main>
                <Typography variant="display1" gutterBottom>Sandvolleyballturneringer i Norge</Typography>
                        ...
                        return (
                            <Grid item xs={12} md={4}>
                                <Paper className={classes.paperContainer}>
                                    ...
                                    <Link href={item.link} >
                                        <Button color="primary" className={classes.buttonLink}>{item.linkText}</Button>
                                    </Link>
                                </Paper>
                            </Grid>
                        )
