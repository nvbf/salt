        ...
        return (
            <div>
                <Typography>
                    <section>
                        <h4>Spiller 1</h4>
                        <PlayerSelect players={players} defaultItem={player1} placeHolder={"Finn Spiller 1"} onChange={this.onSetPlayer1} />
                    </section>
                    <section>
                        <h4>Spiller 2</h4>
...
function PlayerSelect({players, placeHolder, defaultItem, onChange}) {
        const classes =  {};
        return (
                <Downshift onChange={onChange} defaultSelectedItem={defaultItem} itemToString={item => item ? `${item.firstname} ${item.lastname}` : ''}>
